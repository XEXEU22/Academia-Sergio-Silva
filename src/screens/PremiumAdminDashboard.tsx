          ...
          <div className="bg-background-dark min-h-screen flex flex-col text-slate-100 font-display">
                ...
                <motion.main
                        ...
                        <section className="space-y-2">
                                  <h1 className="text-4xl font-black tracking-tighter">Ola, {profile?.full_name?.split(' ')[0] || 'Admin'}</h1>
                                  <p className="text-slate-500 text-sm font-medium">Gestao centralizada da Academia Sergio Silva.</p>
                        </section>
                  ...
                  {/* Admin Actions */}
                        <section className="space-y-6">
                                  <h3 className="text-lg font-bold tracking-tight">Ferramentas Rapidas</h3>
                  ...
                  {/* Atalho Financeiro */}
                        <section className="p-8 rounded-[2rem] bg-gradient-to-br from-primary/10 to-transparent border border-primary/20 relative overflow-hidden">
                                  <div className="relative z-10 space-y-4">
                                              <h4 className="text-xl font-black text-white">Proximos Passos</h4>
