        ...
        <div className="flex items-center gap-2">
          ...
          <motion.button 
            ...
            className={`flex items-center gap-2 rounded-xl border border-white/10 pr-3 pl-1.5 py-1.5 transition-colors ${
              user ? 'bg-rose-500/10 hover:bg-rose-500/20 border-rose-500/20' : 'bg-white/5 hover:bg-white/10'
            }`}
          >
            {user ? (
              <>
                <div className="relative size-7 rounded-lg overflow-hidden bg-rose-500/20 flex items-center justify-center border border-rose-500/30 shrink-0 text-rose-500">
                  <LogOut size={14} />
                </div>
                <span className="text-[9px] font-black uppercase text-rose-500 tracking-widest whitespace-nowrap">Sair</span>
              </>
            ) : (
              <>
